...
export default function EditProductPage() {
  ...
  const loadProduct = async () => {
    try {
      const product = await productsApi.getOne(params.id as string)
      setFormData({
        name: product.name,
        ...
        specifications: {
          ...
          sellType: product.specifications?.sellType || "",
        },
        images: product.images || {
          image1: { url: product.imageUrl || "", base64: product.imageBase64 || "" },
          image2: { url: "", base64: "" },
          image3: { url: "", base64: "" },
        },
      })
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold tracking-tight">{t.products.editProduct}</h1>
        </div>
      </div>
